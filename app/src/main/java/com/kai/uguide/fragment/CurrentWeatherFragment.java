 ...
 */
package com.kai.uguide.fragment;
...
import com.kai.uguide.utils.WeatherIconMapper;
import com.kai.uguide.utils.WeatherUtil;
...
public class CurrentWeatherFragment extends WeatherFragment {
    ...
    private void refresh() {
       config = new WeatherConfig();
        String cityId = prefs.getString("cityid", "1880251");
       ...
       if (cityId == null) {
        ...
        weatherClient.getCurrentCondition(cityId, new WeatherClient.WeatherEventListener() {
            ...
            public void onWeatherRetrieved(CurrentWeather cWeather) {
                ...
                Log.d("SwA", "Temp [" + temp + "]");
                Log.d("SwA", "Val [" + weather.temperature.getTemp() + "]");
...
//                Fragment weatherFrag = getFragmentManager().findFragmentById(R.id.currentWeatherFrag);
//                FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) weatherFrag.getView().getLayoutParams();
//                params.height = 300;
//                weatherFrag.getView().setLayoutParams(params);
            }
